...
const recentTransactions = [
    ...
    { id: 'TX-402', user: 'Sara_99', type: 'Campaign Reward', amount: '+$1,200.00', status: 'Pending', date: '14m ago' },
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
                ...
                <div className="xl:col-span-2 bg-primary border border-primary/20 rounded-lg p-6 text-black relative overflow-hidden group">
                    <div className="relative z-10 flex flex-col h-full">
                        ...
                        <div className="mt-8">
                            <h2 className="text-4xl font-semibold tracking-tighter mb-2">$1,482,094.20</h2>
                ...
                <div className="xl:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <AdminStatCard label="Total Payouts" value="$42,801" change="-2.4%" icon={ArrowDownRight} color="emerald-500" />
                    <AdminStatCard label="Escrowed" value="$12,400" change="+8.1%" icon={CreditCard} color="indigo-500" />
                </div>
            </div>
